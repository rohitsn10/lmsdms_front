...
import { useGetDocumentDataOfStatusIdnintyQuery } from "api/auth/dashboardApi"; // Use the new API
...
const DueSOPDocument = () => {
  ...
  const { data, refetch, isLoading, isError } = useGetDocumentDataOfStatusIdnintyQuery({
